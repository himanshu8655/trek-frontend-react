...
function TrekCard({ name, description, image, onEdit, onDelete, id }) {
  return (
    <div className="trek-card">
      ...
      <div className="trek-card-content">
        ...
        <div className="trek-card-buttons">
          <button className="trek-card-button edit-button" onClick={(e) => { e.stopPropagation(); onEdit(); }}>Edit</button>
          <button className="trek-card-button delete-button" onClick={(e) => { e.stopPropagation(); onDelete(); }}>Delete</button>
        </div>
      </div>
    </div>
  );
